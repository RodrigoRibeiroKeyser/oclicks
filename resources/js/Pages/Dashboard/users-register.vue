            ...
            <v-col>
                ...
                <v-form @submit.prevent="submit">
                    <v-text-field id="name" type="text" v-model="form.name" label="Nome" color="primary"  :messages="[form.errors.name]"
                        ...
                        <v-text-field id="login" type="text" v-model="form.login" label="login" color="primary"  :messages="[form.errors.name]"
                        :class="[form.errors.name ? 'onerror' : '']" @click="form.errors.login = null"></v-text-field>
